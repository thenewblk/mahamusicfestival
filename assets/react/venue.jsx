...
module.exports = React.createClass({
	...
	render: function() {
		...
		return (
			<div className="content-wrapper venue-section community-section" id="venue">
				<div className="content-inner">
          <div className="venue-map">
  					<div className="venue-legend desktop">
            ...
            <div className="venue-legend mobile">
              <p className="legend-item">
                <img className="item-icon" src="/wp-content/themes/maha2015.v2.2/dist/images/icons-medical.svg" /> Nebraska Medicine First Aid + Security
              </p>
              <p className="legend-item">
          ...
          <div className="venue-schedules">
            <div className="schedule-main">
              <h2 className="schedule-title">2015 SCHEDULE</h2>
              <table>
                <tr>
                  <td>Noon</td>
                  <td></td>
                ...
                <tr>
                  ...
                  <td className="band_event">BOTH</td>
                </tr>
                <tr>
                  <td className="time">12:40</td>
                  <td className="location">Javlin Stage</td>
                  <td className="band_event">FREAKABOUT</td>
                </tr>
                <tr>
                  <td className="time">1:15</td>
                  <td className="location">Weitz Stage</td>
                  <td className="band_event">Ex Hex</td>
                </tr>
                <tr>
                  <td className="time">2:05</td>
                  <td className="location">Javlin Stage</td>
                  <td className="band_event">Alvvays</td>
                </tr>
                <tr>
                  <td className="time">2:55</td>
                  <td className="location">Weitz Stage</td>
                  <td className="band_event">The Jayhawks</td>
                </tr>
                <tr>
                ...
                <tr>
                  <td className="time">5:55</td>
                  <td className="location">Javlin Stage</td>
                  <td className="band_event">Speedy Ortiz</td>
                </tr>
                <tr>
                  <td className="time">6:50</td>
                  <td className="location">Weitz Stage</td>
                  <td className="band_event">Atmosphere</td>
                </tr>
                <tr>
                  <td className="time">8:00</td>
                  <td className="location">Javlin Stage</td>
                  <td className="band_event">The Good Life</td>
                </tr>
                <tr>
                  <td className="time">9:00</td>
                  <td className="location">Weitz Stage</td>
                  <td className="band_event">Purity Ring</td>
                </tr>
                <tr>
                  <td className="time">10:20</td>
                  <td className="location">Weitz Stage</td>
                  <td className="band_event">Modest Mouse</td>
                </tr>
              </table>
              <p>Midnight  Show Over – See you in 2016!</p>
              <p>All times are approximate | Lineup is subject to change</p>
            </div>
          	<div className="schedule-comedy">
							<h2 className="schedule-title">THE GLOBE</h2>
							<h3 className="comedy-title">Louder than a Bomb Poetry Slam</h3>
  						<p className="comedy-time">1:00 - 2:00 PM & 3:40 - 4:40 PM</p>
							<ul className="event-list">
								<li>Grace Bartling</li>
								<li>Amber Bridgeford</li>
								<li>Jack Buchanon</li>
								<li>Cheyanne Buckles</li>
								<li>Tiana Carr</li>
								<li>Emma Craig</li>
								<li>Foster Collins</li>
								<li>Charlotte Elsasser</li>
								<li>Lia Hagen</li>
								<li>Camille Harrah</li>
								<li>Mary Hilton</li>
								<li>Ishyah Holland</li>
								<li>Tiauna Lewis (Also at 2:01 on Weitz Stage)</li>
								<li>Evangeline Mantler</li>
								<li>Andy Mitchell</li>
								<li>Serenity Stokes</li>
								<li>Bianca Swift (Also at 12:36 PM on Weitz Stage)</li>
								<li>Theresa Woods</li>
							</ul>
							<h3 className="comedy-title">OK Party Comedy</h3>
							<p className="comedy-time">2:05 - 3:35 PM & 4:45 - 6:15 PM</p>
							<ul className="event-list">
								<li>Headliner – Dave Ross (Los Angeles)</li>
								<li>Ian Douglas Terry (Denver)</li>
								<li>Zach Reinert (Denver)</li>
								<li>Mike Perry (Omaha)</li>
								<li>Ryan de la Garza (Omaha)</li>
								<li>Cody Wayne Hurd (Omaha)</li>
								<li>Kyle O’Reilly (Omaha)</li>
							</ul>
          	</div>
					</div>
      	</div>
