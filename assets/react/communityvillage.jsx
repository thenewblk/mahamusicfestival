						...
						<div className={"cv-faq-content"+faq_class}> 
							<div className="cv-faq-left">
								<div className="cv-faq-item">
									...
									<p className="cv-faq-copy">Answer:  The application window will open on June 1st, 2015 and remain open until midnight on June 26th.  Applications received after midnight on June 26th will not be considered.</p>
								</div>
								<div className="cv-faq-item">
